 ...
 * 钟是志
 * 2018年9月13日
 * 修改 https://github.com/SoAanyip/React-FileUpload
 * 改为一个单纯的组件方便使用.api 请参看github
 */
...
export default class FileUpload  extends Component{
    ...
    IECallback(dataType, frameId) {
        ...
        try {
            ...
            resp.json = JSON ? JSON.parse(resp.responseText) : evil(resp.responseText);
        } catch (e) {
            /*如果是包含了<pre>*/
            if (e.message && e.message.indexOf('Unexpected token') >= 0) {
                ...
                if (resp.responseText.indexOf('{') >= 0) {
                    ...
                    return JSON ? JSON.parse(msg) : evil(msg);
                }
